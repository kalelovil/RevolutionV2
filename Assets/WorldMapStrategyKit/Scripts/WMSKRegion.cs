	...
	public partial class WMSK : MonoBehaviour {
		...
		public void RegionErase (List<Region> regions, Color eraseColor, bool invertMode) {
			...
			if (_earthStyle == EARTH_STYLE.SolidColor) {
				...
				texture = Instantiate (transform.GetComponent<Renderer> ().sharedMaterial.mainTexture) as Texture2D;
			}
		...
		public GameObject DrawRegionOutline (string name, Region region, Texture2D borderTexure = null, float borderWidth = 0.1f, Color tintColor = default(Color), float textureTiling = 1f, float animationSpeed = 0f) {
