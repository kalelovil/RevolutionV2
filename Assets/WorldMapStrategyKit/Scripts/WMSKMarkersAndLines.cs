...
namespace WorldMapStrategyKit {
	...
	public partial class WMSK : MonoBehaviour {
		...
		public void AddMarker2DSprite (GameObject sprite, Vector3 planeLocation, float scale, bool enableEvents = false) {
			AddMarker2DSprite (sprite, planeLocation, new Vector2 (scale, scale * mapWidth / mapHeight), enableEvents);
		}
		...
		/// <param name="enableEvents">If set to <c>true</c> enable events, a MarkerClickHandler script will be attached to the sprite gameObject. You can use the OnMarkerClick field to hook your mouse click handler.</param>
		public void AddMarker2DSprite (GameObject sprite, Vector3 planeLocation, Vector2 scale, bool enableEvents = false) {
		...
		/// </summary>
		public void AddMarker3DObject (GameObject marker, Vector3 planeLocation, float scale) {
