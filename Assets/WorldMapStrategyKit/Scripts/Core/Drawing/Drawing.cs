...
namespace WorldMapStrategyKit {
	public static class Drawing {
		...
		public static TextMesh CreateText (string text, GameObject parent, Vector2 center, Font labelFont, Color textColor, bool showShadow, Material shadowMaterial, Color shadowColor, TextAnchor anchor = TextAnchor.MiddleCenter) {
			TextMesh dummy;
			return CreateText (text, parent, center, labelFont, textColor, showShadow, shadowMaterial, shadowColor, out dummy, anchor);
		}

		public static TextMesh CreateText (string text, GameObject parent, Vector2 center, Font labelFont, Color textColor, bool showShadow, Material shadowMaterial, Color shadowColor, out TextMesh shadowTextMesh, TextAnchor anchor = TextAnchor.MiddleCenter) {
			// create base text
