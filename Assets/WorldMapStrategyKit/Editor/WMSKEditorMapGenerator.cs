...
namespace WorldMapStrategyKit {
	...
	public partial class WMSKEditorInspector : Editor {
		...
		SerializedProperty mapGenerationQuality, outputFolder, seed, seedNames, numProvinces, numCountries;
		...
		SerializedProperty heightGradient, heightGradientPreset, gradientPerPixel, changeStyle, generateNormalMap, normalMapBumpiness;
		Material previewMat;
		...
		public bool ShowMapGeneratorOptions () {
			...
			EditorGUI.BeginChangeCheck ();
			EditorGUILayout.PropertyField (userHeightMapTexture, new GUIContent ("Texture", "Optional heightmap texture"));
			if (EditorGUI.EndChangeCheck ()) {
