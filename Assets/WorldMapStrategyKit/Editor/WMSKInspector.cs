        ...
        public override void OnInspectorGUI() {
            ...
            if (expandEarthSection) {
                ...
                if (_map.showEarth) {
                    ...
                    _map.waterMask = (Texture2D)EditorGUILayout.ObjectField(new GUIContent("Water Mask", waterMaskHelpText), _map.waterMask, typeof(Texture2D), false);
                    ...
                    _map.heightMapTexture = (Texture2D)EditorGUILayout.ObjectField(new GUIContent("Height Map", "Heightmap is used to draw elevation in Render Viewport and in pathfinding."), _map.heightMapTexture, typeof(Texture2D), false);
                }
